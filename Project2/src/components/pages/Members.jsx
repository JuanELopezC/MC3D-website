...
const advisors = [
  { name: "Dr. Smith", picture: "smith.jpg", role: "Advisor", bio: "Guides our club projects." },
];
...
const officers = [
  ...
  { name: "Bradley", picture: "bradley.jpg", role: "Vice-President", bio: "Chill art guy" },
  ...
  { name: "Jorge", picture: "jorge.jpg", role: "Software technician", bio: "Best beaner" },
];

const members = [
  { name: "Josh", picture: "", role: "Member", bio: "Chill guy." },
  { name: "Kylind", picture: "kylind.jpg", role: "Member", bio: "my roommate , sadly." },
];
      ...
      <section className="members-section">
        <div className="container">
          ...
          <p className="members-intro">
            ...
            students to experienced advisors. Hover over any member to learn more!
          </p>
        </div>
      </section>
